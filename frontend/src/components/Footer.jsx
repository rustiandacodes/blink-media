...
const Footer = () => {
  return (
    <footer className="md:p-8">
      <div className=" py-10 mx-auto md:rounded-2xl bg-green-forest md:p-20 p-10">
        <p className="text-xl md:text-2xl font-bold text-green-darker cursor-pointer">
          *Blink <span className="text-white">Media</span>
        </p>
        <p className="my-5 text-white md:w-1/4 w-full">Unlocking Ideas, Inspiring Minds: Your Gateway to Limitless Knowledge 🧠</p>
        <hr className="my-8" />
